...
export function SearchAndFilters({ movements }: SearchAndFiltersProps) {
  ...
  const debouncedSearchParams = useDebouncedCallback((searchParams: URLSearchParams) => {
      ...
      <div className="flex items-center gap-4 w-full">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="time" className="whitespace-nowrap">
              Time
            </SelectItem>
            <SelectItem value="time-with-cap" className="whitespace-nowrap">
              Time with Cap
            </SelectItem>
            <SelectItem value="pass-fail" className="whitespace-nowrap">
              Pass/Fail
            </SelectItem>
            <SelectItem value="rounds-reps" className="whitespace-nowrap">
              Rounds & Reps
            </SelectItem>
            <SelectItem value="reps" className="whitespace-nowrap">
              Reps
            </SelectItem>
            <SelectItem value="emom" className="whitespace-nowrap">
              EMOM
            </SelectItem>
            <SelectItem value="load" className="whitespace-nowrap">
              Load
            </SelectItem>
            <SelectItem value="calories" className="whitespace-nowrap">
              Calories
            </SelectItem>
            <SelectItem value="points" className="whitespace-nowrap">
              Points
            </SelectItem>
            <SelectItem value="meters" className="whitespace-nowrap">
              Meters
            </SelectItem>
            <SelectItem value="feet" className="whitespace-nowrap">
              Feet
            </SelectItem>
          </SelectContent>
        </Select>
